				...
				<ul>
					<li class="pull-left">
						<div class="nav-previous">
							...
							<a href=" <?php echo esc_url($prev); ?>"><i class="fa fa-chevron-left"></i><?php esc_html_e('Previous page','bloghub'); ?> <span><?php echo esc_html($prev_post->post_title) ; ?></span> </a> <?php } ?></div>
						</li>
						<li class="pull-right">
							<div class="nav-next">
								<?php 
								...
								<a href="<?php echo esc_url($next);  ?>"><?php esc_html_e('Next page','bloghub'); ?> <i class="fa fa-chevron-right"></i> <span><?php echo esc_html($next_post->post_title); ?></span> </a> <?php } ?>
							</div>
						</li>
					</ul>
				</nav>
